Feature: Adding context to every partner
    ...
    Scenario: 2. Login as Bauer in new tab
        When I click on the <loginAsBauer>
    ...
    Scenario Outline: 4. Create offer
    ...
    Scenario Outline: 5. Create contract form offer
    ...
    Scenario: 6. Logout from context to Sunrise System
        ...
        And I wait for <SunrieLogo> to be visible
        Then <SunrieLogo> is visible